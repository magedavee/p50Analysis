...
public:
    ...
    static G4Material* nat_Li;          ///< natural lithium
    ...
    static G4Material* nat_B;           ///< natural boron
    ...
    static G4Material* nat_Pb;          ///< natural lead
    ...
    static G4Material* Polyeth;         ///< Polyethylene
    static G4Material* BPoly;           ///< Borated (5% by mass) polyethylene
    static G4Material* LiPoly;          ///< Lithiated (5% by mass) polyethlyene
