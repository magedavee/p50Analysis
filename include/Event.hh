...
public:
  ...
  Double_t PositionX[2500];
  Double_t PositionY[2500];
  Double_t AirGap;//25.4*mm;             // air gap between segments
  ...
  Double_t PMTscale;                  //PMT photocathode radius in inches
  Double_t ShieldLead;
  Double_t ShieldPolyB;
  Double_t ShieldPolyLi;
  ...
  ClassDef(Run,1)  //Simple event class
};
