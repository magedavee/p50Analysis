...
#  REMOVE_FROM_LIST(root_flags "${root_libs_all}" "${root_library}")
  ...
  SET(ROOT_LIBRARIES ${root_flags} -lXMLIO)
  ...
  #  NO_DEFAULT_PATH
  #  )
  SET( ROOT_CINT_EXECUTABLE ${ROOT_BINARY_DIR}/rootcint)
  MESSAGE("ROOT_BINARY_DIR = ${ROOT_BINARY_DIR}; ROOT_CINT_EXECUTABLE = ${ROOT_CINT_EXECUTABLE}")
