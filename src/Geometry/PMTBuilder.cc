...
void PMTBuilder::construct() {
    ...
    main_log = new G4LogicalVolume(pmt_tube, MaterialsHelper::SS444, "PMT_main_log");
    ...
    G4LogicalVolume* capsule_log = new G4LogicalVolume(pmt_capsule_tube, MaterialsHelper::Quartz, "PMT_capsule_log");
    ...
    G4LogicalVolume* vacuum_log = new G4LogicalVolume(pmt_vacuum_tube, MaterialsHelper::Vacuum, "PMT_vacuum_log");
